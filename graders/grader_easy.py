"""Grader for Task 1: Basic Emergency Dispatch (easy).
...
try:
    ...
    from server.dispatch_grid_environment import compute_reward, EASY_CALLS
except ImportError:
    try:
        from dispatch_grid.models import DispatchGridAction, EmergencyCall
        from dispatch_grid.server.dispatch_grid_environment import compute_reward, EASY_CALLS
    except ImportError:
        from ..models import DispatchGridAction, EmergencyCall
        from .dispatch_grid_environment import compute_reward, EASY_CALLS
...
class EasyGrader:
    ...
    def __init__(self) -> None:
        ...
        self._calls_by_id = {c.call_id: c for c in EASY_CALLS}
